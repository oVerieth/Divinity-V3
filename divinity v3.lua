...
local gui_divinity_misc_group_usefull_features = gui.Groupbox(gui_divinity_window, "Other Stuff",  10, 335, 280, 450)
...
local gui_divinity_misc_group_indicators_skeet_indicator_new_recharge = gui.Checkbox(gui_divinity_misc_group_indicators, "divinity_misc_group_indicators_skeet_indicator_new_recharge", "New Recharge Indicator", false)
...
local invisible_gui = {
    ...
    gui_divinity_misc_group_indicators_skeet_indicator_position_x = gui.Slider(gui_divinity_misc_group_indicators, "divinity_misc_group_indicators_skeet_indicator_position_x", "Position X", 30, 0, ScreenWeight, 1),
    gui_divinity_misc_group_indicators_skeet_indicator_position_y = gui.Slider(gui_divinity_misc_group_indicators, "divinity_misc_group_indicators_skeet_indicator_position_y", "Position Y", 770, 0, ScreenHeight, 1)
}
...
--Segment
draw.Segment = function(pos_x, pos_y, persentage, start_size, last_size, side, color) --(side 1 - to right and side -1 to left)
    for i = start_size, last_size, 1 do
        draw.Color(20, 20, 20, 150)
        draw.OutlinedCircle(pos_x, pos_y, i)
    end

    for i = 0, (side * 360) * (persentage / 100), side do
        draw.Color(color[1], color[2], color[3], 255)
        draw.Line(pos_x + (math.sin(math.rad(i)) * (start_size - 1)), pos_y + (math.cos(math.rad(i)) * (start_size - 1)), pos_x + (math.sin(math.rad(i)) * (last_size + 1)), pos_y + (math.cos(math.rad(i))* (last_size + 1)))
    end
end
...
local function gui_controller()
    ...
    if misc_tab_active == true then
        ...
        invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:SetInvisible(true)
        invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:SetInvisible(true)
        ...
        if not gui_divinity_misc_group_indicators_skeet_indicator:GetValue() then
            gui_divinity_misc_group_indicators_skeet_indicator_new_recharge:SetDisabled(true)
            ...
            gui_divinity_misc_group_indicators_skeet_indicator_new_recharge:SetDisabled(false)
...
local function anti_aim_main_yaw( ... )
    ...
    --the fastest
    if globals.CurTime() < static_aa_curtime then
...
function misc_indicators()
    ...
    if gui_divinity_misc_group_indicators_skeet_indicator:GetValue() and gui_divinity_misc_group_indicators_skeet_indicator_old_fake:GetValue() then 
        if body_yaw <= 58 and body_yaw >= 48 then 
            ...
            draw.Text(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue(), invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()+30, "FAKE")
            draw.TextShadow(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue()-1, invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()+29, "FAKE")
    ...
    elseif gui_divinity_misc_group_indicators_skeet_indicator:GetValue() and not gui_divinity_misc_group_indicators_skeet_indicator_old_fake:GetValue() then
        if gui_divinity_misc_group_indicators_skeet_indicator_filled_background:GetValue() then
            draw.Color(0,0,0,255)
            draw.FilledRect(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue(), invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()+37+fake_height, invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue()+fake_weight, invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()+34+fake_height) 
        end
        draw.Color(gui_divinity_misc_group_indicators_skeet_indicator_color:GetValue())
        draw.FilledRect(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue(), invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()+37+fake_height, invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue()+(fake_weight*(body_yaw/58)), invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()+34+fake_height)
        draw.Color(gui_divinity_misc_group_indicators_skeet_indicator_color:GetValue())
        draw.Text(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue(), invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()+30, "FAKE")
        draw.TextShadow(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue()-1, invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()+29, "FAKE")
    end

    local hideshots_active = gui.GetValue("rbot.antiaim.condition.shiftonshot")
    local nextattack_local_doubletap = local_entity:GetPropEntity('m_hActiveWeapon'):GetPropFloat('LocalActiveWeaponData', 'm_flNextPrimaryAttack')
    local nextattack_local_hideshots = local_entity:GetPropEntity('m_hActiveWeapon'):GetPropFloat('LocalActiveWeaponData', 'm_flNextPrimaryAttack')

    local doubletap_curtime = globals.CurTime()
    ...
    local hideshots_curtime = globals.CurTime()
    ...
    if gui_divinity_misc_group_indicators_skeet_indicator:GetValue() then
        if DtIsActive == true then
            if nextattack_local_doubletap > globals.CurTime() then
                if gui_divinity_misc_group_indicators_skeet_indicator_new_recharge:GetValue() then
                    draw.Color(240,10,0,255)
        ...
        if FdIsActive == true then
            draw.Color(gui_divinity_misc_group_indicators_skeet_indicator_color:GetValue())
            draw.Text(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue(), invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()-90,"FD")
            draw.TextShadow(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue()-1, invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()-91,"FD")
        end

        draw.Color(gui_divinity_misc_group_indicators_skeet_indicator_color:GetValue())
        draw.Text(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue(), invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()+60,"DMG:")
        draw.TextShadow(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue()-1, invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()+59,"DMG:")
        draw.Text(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue(), invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()+90,"HC:")
        draw.TextShadow(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue()-1, invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()+89,"HC:")
        ...
        if weaponclass == 'knife' or local_entity:GetWeaponID() == 43 or local_entity:GetWeaponID() == 44 or local_entity:GetWeaponID() == 45 or local_entity:GetWeaponID() == 46 or local_entity:GetWeaponID() == 47 or local_entity:GetWeaponID() ==48 then
            draw.Text(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue()+72, invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()+60, "AUTO")
            draw.TextShadow(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue()+71, invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()+59, "AUTO")
            draw.Text(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue()+72, invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()+90, "AUTO")
            draw.TextShadow(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue()+71, invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()+89, "AUTO")
        elseif local_entity:GetWeaponID() == 31 then
            ...
            draw.Text(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue()+72, invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()+90, gui.GetValue("rbot.accuracy.weapon."..weaponclass..".hitchance"))
            draw.TextShadow(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue()+71, invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()+89, gui.GetValue("rbot.accuracy.weapon."..weaponclass..".hitchance"))
        end

        --desync side
        if gui.GetValue("rbot.antiaim.base.rotation") >= 0 then
            draw.Text(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue(), invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue(), "LEFT")
            draw.TextShadow(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue()-1, invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()-1, "LEFT")
            draw.Text(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue(), invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue(), "LEFT")
            draw.TextShadow(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue()-1, invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()-1, "LEFT") 
        elseif gui.GetValue("rbot.antiaim.base.rotation") < 0 then
            draw.Text(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue(), invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue(), "RIGHT")
            draw.TextShadow(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue()-1, invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()-1, "RIGHT")
            draw.Text(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue(), invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue(), "RIGHT")
            draw.TextShadow(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue()-1, invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()-1, "RIGHT")
        end 
        ...
        if gui_divinity_antiaim_group_misc_freestand:GetValue() then
            draw.Text(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue(), invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()-120,"FS")
            draw.TextShadow(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue()-1, invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()-121,"FS")
        end
        ...
        if indicators_cache.lc_factor_local == true then
            draw.Color(gui_divinity_misc_group_indicators_skeet_indicator_color:GetValue())
            draw.Text(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue(), invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()-150, "LC")
            draw.TextShadow(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue()-1, invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()-151, "LC")
        else
            draw.Color(240,10,0,255)
            draw.Text(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue(), invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()-150,"LC")
            draw.TextShadow(invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_x:GetValue()-1, invisible_gui.gui_divinity_misc_group_indicators_skeet_indicator_position_y:GetValue()-151, "LC")
